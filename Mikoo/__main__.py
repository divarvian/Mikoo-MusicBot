...
from config import (LOG_GROUP_ID, LOG_SESSION, STRING1, STRING2, STRING3,
                    STRING4, STRING5)
from Mikoo import (ASS_CLI_1, ASS_CLI_2, ASS_CLI_3, ASS_CLI_4, ASS_CLI_5,
                   ASSID1, ASSID2, ASSID3, ASSID4, ASSID5, ASSNAME1, ASSNAME2,
                   ASSNAME3, ASSNAME4, ASSNAME5, BOT_ID, BOT_NAME, LOG_CLIENT,
                   OWNER_ID, app)
from Mikoo.Core.Clients.cli import LOG_CLIENT
from Mikoo.Core.PyTgCalls.Mikoo import (pytgcalls1, pytgcalls2, pytgcalls3,
                                        pytgcalls4, pytgcalls5)
from Mikoo.Database import (get_active_chats, get_active_video_chats,
                            get_sudoers, is_on_off, remove_active_chat,
                            remove_active_video_chat)
from Mikoo.Inline import private_panel
from Mikoo.Plugins import ALL_MODULES
from Mikoo.Utilities.inline import paginate_modules
...
async def initiate_bot():
    ...
    console.print(
        "[bold green]Congrats!! Mikoo Music Bot has started successfully!\n"
    )
    try:
    ...
    if STRING1 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_1.join_chat("OfficialMikoo")
            await ASS_CLI_1.join_chat("MikooSupport")
        except:
            pass
    ...
    if STRING2 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_2.join_chat("OfficialMikoo")
            await ASS_CLI_2.join_chat("MikooSupport")
        except:
            pass
    ...
    if STRING3 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_3.join_chat("OfficialMikoo")
            await ASS_CLI_3.join_chat("MikooSupport")
        except:
            pass
    ...
    if STRING4 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_4.join_chat("OfficialMikoo")
            await ASS_CLI_4.join_chat("MikooSupport")
        except:
            pass
    ...
    if STRING5 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_5.join_chat("OfficialMikoo")
            await ASS_CLI_5.join_chat("MikooSupport")
        except:
            pass
    ...
    if LOG_SESSION != "None":
        try:
            ...
            return
        try:
            await LOG_CLIENT.join_chat("OfficialMikoo")
            await LOG_CLIENT.join_chat("MikooSupport")
        except:
            pass
    console.print(f"└[red] Mikoo Music Bot Boot Completed.")
    if STRING1 != "None":
