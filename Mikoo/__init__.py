...
from Mikoo.Core.Clients.cli import (ASS_CLI_1, ASS_CLI_2, ASS_CLI_3, ASS_CLI_4,
                                    ASS_CLI_5, LOG_CLIENT, app)
from Mikoo.Utilities.changers import time_to_seconds
from Mikoo.Utilities.tasks import install_requirements
...
async def initiate_bot():
    ...
    header.add_column(
        "\x4d\x69\x6b\x6f\x6f\x20\x2d\x20\x4d\x75\x73\x69\x63\x20\x42\x6f\x74\x20\x3a\x20\x54\x68\x65\x20\x4d\x6f\x73\x74\x20\x41\x64\x76\x61\x6e\x63\x65\x64\x20\x4d\x75\x73\x69\x63\x20\x42\x6f\x74"
    )
    console.print(header)
    with console.status(
        "[magenta] Mikoo Music Bot Booting...",
    ) as status:
