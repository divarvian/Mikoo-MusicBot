...
from Mikoo.Core.PyTgCalls.Mikoo import (pause_stream, resume_stream,
                                        skip_stream, skip_video_stream,
                                        stop_stream)
from Mikoo.Database import (is_active_chat, is_music_playing, music_off,
                            music_on, remove_active_chat,
                            remove_active_video_chat)
from Mikoo.Decorators.admins import AdminRightsCheck
from Mikoo.Decorators.checker import checker, checkerCB
from Mikoo.Inline import audio_markup, primary_markup, secondary_markup2
