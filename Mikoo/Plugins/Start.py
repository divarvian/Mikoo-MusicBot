...
from Mikoo import ASSIDS, BOT_ID, MUSIC_BOT_NAME, OWNER_ID, SUDOERS, app
from Mikoo import boottime as bot_start_time
from Mikoo import db, random_assistant
from Mikoo.Core.PyTgCalls import Mikoo
from Mikoo.Database import (add_nonadmin_chat, add_served_chat,
...
from Mikoo.Decorators.admins import ActualAdminCB
from Mikoo.Decorators.permission import PermissionCheck
from Mikoo.Inline import (custommarkup, dashmarkup, setting_markup,
                          setting_markup2, start_pannel, usermarkup, volmarkup)
from Mikoo.Utilities.assistant import get_assistant_details
from Mikoo.Utilities.ping import get_readable_time
...
async def start_markup_check(_, CallbackQuery):
    ...
    if command == "LV":
        ...
        volume = 25
        try:
            await Mikoo.pytgcalls.change_volume_call(c_id, volume)
    ...
    if command == "DIT":
        ...
        await CallbackQuery.answer(
            f"Mikoo Disk Usage: {diske}%", show_alert=True
        )
