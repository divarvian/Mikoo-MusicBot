<p align="center"><img src="https://github.com/divarvian/Mikoo-MusicBot/blob/master/Utils/icon.gif" alt="ICON" width="250" height="250"/></p>
...
```console
shikhar@MacBook~ $ git clone https://github.com/divarvian/Mikoo-MusicBot
